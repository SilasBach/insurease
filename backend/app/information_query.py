...
all_tools = []
for full_policy_name, agent in agents.items():
    company_name, policy_name = full_policy_name.split("_")
    policy_summary = (
        f"This tool provides information about the {company_name} {policy_name} insurance policy. Use "
...
top_agent = OpenAIAgent.from_tools(
    all_tools,  # Use all tools directly instead of tool_retriever
    system_prompt=""" \
